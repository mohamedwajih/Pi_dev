...
public class Preference {
    ...
    int aventurier;
    public Preference(){}
    public Preference(int idUser, int nerveux, int attirant, int sensible, int romantique, int sportif, int artiste, int musicien, int famille, int actif, int sociable, int fidele, int soigne, int genereux, int ambitieux, int jaloux, int serieux, int drole, int materialiste, int tolerant, int aventurier) {
        this.idUser = idUser;
